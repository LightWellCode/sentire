...
public class zzzSensorManagementActivity extends AppCompatActivity {
    ...
    private TextView mScanStatus, mDeviceStatus, mSensorData, mTempData;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.zzzactivity_sensor_management);
        ...
        mTempData       = (TextView) findViewById(R.id.tempData);
    }
    ...
    private BluetoothGattCallback mGattCallback = new BluetoothGattCallback() {
        ...
        private void enableNextSensor(BluetoothGatt gatt) {
            ...
            switch (lState) {
                ...
                case 1:
                    // TBD
                    Log.i(C.LOGTAG, "Sensor Temperature ...");
                    characteristic = gatt.getService(C.TMP_SERVICE).getCharacteristic(C.TMP_CONFIG_CHAR);
                    characteristic.setValue(new byte[] {0x01});
                    break;
                default:
        ...
        private void readNextSensor(BluetoothGatt gatt) {
            ...
            switch (lState) {
                case 0:
                    ...
                    break;
                case 1:
                    Log.i(C.LOGTAG, "Reading second sensor");
                    characteristic = gatt.getService(C.TMP_SERVICE).getCharacteristic(C.TMP_DATA_CHAR);
                default:
                    Log.i(C.LOGTAG, "All senors read...");
                    return;
            }
            Log.i(C.LOGTAG, "state machine: " + String.valueOf(lState));
        ...
        private void setNotifyNextSensor(BluetoothGatt gatt) {
            ...
            switch (lState) {
                ...
                case 1:
                    ...
                    break;
                default:
                    mHandler.sendEmptyMessage(C.MSG_DISMISS);
                    return;
            }
            gatt.setCharacteristicNotification(characteristic, true);
            BluetoothGattDescriptor desc = characteristic.getDescriptor(C.CONFIG_DESCRIPTOR);
        ...
        public void handleMessage(Message msg) {
            ...
            switch (msg.what) {
                ...
                case C.MSG_TMP:
                    ...
                    mTempData.setText(characteristic.getFloatValue(BluetoothGattCharacteristic.FORMAT_FLOAT, 0).toString());
